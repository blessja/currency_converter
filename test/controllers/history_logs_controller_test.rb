...
class HistoryLogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history_log" do
    assert_difference("HistoryLog.count") do
      post history_logs_url, params: { history_log: { amount: @history_log.amount, from: @history_log.from, result: @history_log.result, to: @history_log.to } }
    end
  ...
  test "should update history_log" do
    patch history_log_url(@history_log), params: { history_log: { amount: @history_log.amount, from: @history_log.from, result: @history_log.result, to: @history_log.to } }
